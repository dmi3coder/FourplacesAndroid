...
import goldenbyte.codemonkeys.android4places.adapters.CafeAdapter;
import goldenbyte.codemonkeys.android4places.backend.CafeLoader;
import goldenbyte.codemonkeys.android4places.bean.Cafe;
import goldenbyte.codemonkeys.android4places.fragment.SearchFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    @Bind({R.id.header_button_all,R.id.header_button_cafe,R.id.header_button_night_club,R.id.header_button_fun,R.id.header_button_more})List<TextView> headerButtons;
    ...
    private void defineTypeButtons() {
        for(int currentButton = 0;currentButton<headerButtons.size();currentButton++){
            final int currentButtonFinal = currentButton;
//            MaterialRippleLayout.on(headerButtons.get(currentButton))
